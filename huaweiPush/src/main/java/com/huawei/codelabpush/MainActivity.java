...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button tvSetPush;

    private Button tvSetAAID;

    private Button tvSetAutoInit;
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_get_aaid) {
            setAAID(tvSetAAID.getText().toString().equals(getString(R.string.get_aaid)));
        } else if (viewId == R.id.btn_get_token) {
            getToken();
        } else if (viewId == R.id.btn_delete_token) {
            deleteToken();
        } else if (viewId == R.id.btn_set_push) {
            setReceiveNotifyMsg(tvSetPush.getText().toString().equals(getString(R.string.set_push_enable)));
        } else if (viewId == R.id.btn_add_topic) {
            addTopic();
        } else if (viewId == R.id.btn_delete_topic) {
            deleteTopic();
        } else if (viewId == R.id.btn_action) {
            openActivityByAction();
        } else if (viewId == R.id.btn_generate_intent) {
            generateIntentUri();
        } else if (viewId == R.id.btn_is_autoInit_enabled) {
            isAutoInitEnabled();
        } else if (viewId == R.id.btn_set_autoInit_enabled) {
